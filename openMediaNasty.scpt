...
repeat numLines times
  ...
  if("youtube" is in pieceString)
    ...
    tell application "Safari"
          set queryYoutube to h & pieceName
    ...
    tell application "Safari"
       ...
       if("kat" is in querySource and "xxx" is in queryType) then
          set queryKatXXX to a & pieceName & f
          open location queryKatXXX
       end if

       if("kat" is in querySource and "xxx" is in queryType) then
          set queryStreamXXX to d & pieceName
          open location queryStreamXXX
       end if
